/*
 * CycleTester_device_spec.c
 *
 * AUTOGENERATED FILE! ONLY EDIT IF YOU ARE A MACHINE!
 *
 *
 *  Created on: 2019-06-19 11:34:55.744751
 *      Author: Dephy Inc
 */
...
const char *cycletester_spec_labels[DEVICE_FIELD_COUNT] = {
	"rigid",
	"id",
	"state_time",
	"accelx",
...
const uint8_t cycletester_spec_formats[DEVICE_FIELD_COUNT] = {
	FORMAT_8U,
	FORMAT_16U,
	FORMAT_32U,
	FORMAT_16S,
...
FlexseaDeviceSpec fx_cycletester_spec = {
		.numFields = DEVICE_FIELD_COUNT,
		.fieldLabels = cycletester_spec_labels,
		.fieldTypes = cycletester_spec_formats
};

#ifndef BOARD_TYPE_FLEXSEA_PLAN

#include "user-mn-DpEb42.h"
uint8_t *cycletester_spec_variables[DEVICE_FIELD_COUNT] = {
	0,
	0,
	...
	(uint8_t *)&rigid1.ctrl._ank_ang_deg_,
	(uint8_t *)&rigid1.ctrl._ank_vel_,
};

uint32_t *fx_dev_timestamp = &rigid1.ctrl.timestamp;
const FlexseaDeviceSpec *fx_this_device_spec = &fx_cycletester_spec;
const uint8_t **_dev_data_pointers = (const uint8_t **) cycletester_spec_variables;
const uint8_t *_dev_field_formats = cycletester_spec_formats;
