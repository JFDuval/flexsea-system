 ...
 *
 *  Created on: 2019-05-09 11:42:54.123213
 *      Author: Dephy Inc
 */
...
uint8_t *habsolute_spec_variables[DEVICE_FIELD_COUNT] = {
	...
	(uint8_t *)&rigid1.ctrl._ank_ang_from_mot_,
	0,
	(uint8_t *)&rigid1.ctrl.step_energy,
	(uint8_t *)&rigid1.ctrl.walkingState,
	(uint8_t *)&rigid1.ctrl.gaitState,
};

uint32_t *fx_dev_timestamp = (void *)0;
