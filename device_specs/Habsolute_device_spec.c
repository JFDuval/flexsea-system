/*
 * Habsolute_device_spec.c
 *
 * AUTOGENERATED FILE! ONLY EDIT IF YOU ARE A MACHINE!
 *
 *
 *  Created on: 2019-06-19 11:34:57.749813
 *      Author: Dephy Inc
 */
...
const char *habsolute_spec_labels[DEVICE_FIELD_COUNT] = {
	"rigid",
	"id",
	"state_time",
	"accelx",
...
const uint8_t habsolute_spec_formats[DEVICE_FIELD_COUNT] = {
	FORMAT_8U,
	FORMAT_16U,
	FORMAT_32U,
	FORMAT_16S,
...
FlexseaDeviceSpec fx_habsolute_spec = {
		.numFields = DEVICE_FIELD_COUNT,
		.fieldLabels = habsolute_spec_labels,
		.fieldTypes = habsolute_spec_formats
};

#ifndef BOARD_TYPE_FLEXSEA_PLAN

#include "user-mn-DpEb42.h"
uint8_t *habsolute_spec_variables[DEVICE_FIELD_COUNT] = {
	0,
	0,
...
const FlexseaDeviceSpec *fx_this_device_spec = &fx_habsolute_spec;
const uint8_t **_dev_data_pointers = (const uint8_t **) habsolute_spec_variables;
const uint8_t *_dev_field_formats = habsolute_spec_formats;
